...
if (isset($_POST)) {
    ...
    VALUES ('$instructor', '$email', '$coursename', '$courselevel', '$taught', '$term', '$map', '$style', '$studio', '$comments') ON DUPLICATE KEY UPDATE
    course_instructor = VALUES(course_instructor),
    instructor_email =  VALUES(instructor_email),
    course_level = VALUES(course_level),
    course_taught = VALUES(course_taught),
    course_period = VALUES(course_period),
    course_mapping = VALUES(course_mapping),
    course_modules = VALUES(course_modules), 
    course_recorded = VALUES(course_recorded),
    course_comments = VALUES(course_comments)";
}
